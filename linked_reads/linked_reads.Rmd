...
<img src=./images/index_orientation.png width=150%>
]
...
.pull-left[
Input: Fastq.<br>
~Run time: 24 hours.<br>
Output: 
+ Bam/alignment qc stats/
...
# Longranger wgs
Obtain SNP calling, phasing and SV information

Input: Fastq.
~ Run time: Three days .small[w. 250GB RAM and 16 cores]
...
todo: Add screenshot of the loupe file.
